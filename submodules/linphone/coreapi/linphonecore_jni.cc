...
//ike
extern "C" void Java_org_linphone_core_LinphoneCoreImpl_setPlayLevel(	JNIEnv*  env
		,jobject  thiz
		,jlong lc
		,jfloat level) {
		linphone_core_set_rec_level((LinphoneCore*)lc,level);
}
...
int speaker_mode = 0;
float mic_vol = 1.0f/64.0f;
int mic_lim = 750;
float speaker_vol = 16.0f;
int speaker_lim = 70;
float mic_vol0 = 1.0f/128.0f;
float speaker_vol0 = 8.0f;


//ike
extern "C" void Java_org_linphone_core_LinphoneCoreImpl_setSpeakerMode(JNIEnv*  env
																		,jobject  thiz
																		,jlong lc, jint m) {

__android_log_print(ANDROID_LOG_ERROR,"NDK","SpeakerMode");

	speaker_mode = m;
}


extern "C" void Java_org_linphone_core_LinphoneCoreImpl_setMicVol(JNIEnv*  env
																		,jobject  thiz
																		,jlong lc
																		,jfloat v) {

__android_log_print(ANDROID_LOG_ERROR,"NDK","MicVol");

	mic_vol = v;
}

extern "C" void Java_org_linphone_core_LinphoneCoreImpl_setMicLim(JNIEnv*  env
																		,jobject  thiz
																		,jlong lc
																		,jint l) {

__android_log_print(ANDROID_LOG_ERROR,"NDK","MicLim");

	mic_lim = l;
}

extern "C" void Java_org_linphone_core_LinphoneCoreImpl_setSpeakerVol(JNIEnv*  env
																		,jobject  thiz
																		,jlong lc
																		,jfloat v) {

__android_log_print(ANDROID_LOG_ERROR,"NDK","SpeakerVol");

	speaker_vol = v;
}

extern "C" void Java_org_linphone_core_LinphoneCoreImpl_setSpeakerLim(JNIEnv*  env
																		,jobject  thiz
																		,jlong lc
																		,jint l) {
__android_log_print(ANDROID_LOG_ERROR,"NDK","SpeakerLim");
