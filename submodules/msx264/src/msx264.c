...
//ike
//		d->vsize.width=MS_VIDEO_SIZE_QCIF_W;
		d->vsize.width=MS_VIDEO_SIZE_QCIF_W/4;
//		d->vsize.height=MS_VIDEO_SIZE_QCIF_H;
		d->vsize.height=MS_VIDEO_SIZE_QCIF_H/4;
		d->fps=4;

__android_log_print(ANDROID_LOG_ERROR,"NDK","BIT RATE");
	}
