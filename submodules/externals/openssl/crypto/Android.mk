...
ifeq ($(TARGET_ARCH),arm)
	MY_LOCAL_CFLAGS := -DOPENSSL_BN_ASM_MONT -DAES_ASM -DSHA1_ASM -DSHA256_ASM -DSHA512_ASM
	MY_LOCAL_SRC_FILES:= 0.9.9-dev/bn/armv4-mont.S \
	                  0.9.9-dev/aes/aes-armv4.S \
	                  0.9.9-dev/sha/sha1-armv4-large.S \
	                  0.9.9-dev/sha/sha256-armv4.S \
	                  0.9.9-dev/sha/sha512-armv4.S
else
	MY_LOCAL_SRC_FILES:= aes/aes_core.c
endif
...
MY_LOCAL_CFLAGS += -DNO_WINDOWS_BRAINDEATH 
...
ifneq ($(TARGET_SIMULATOR),true)
	MY_LOCAL_SHARED_LIBRARIES += libdl
endif
