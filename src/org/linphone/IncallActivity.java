...
public class IncallActivity extends AbstractCalleesActivity implements
	...
	public void onClick(View v) {
		...
		if (id == R.id.addCall) {
			...
			if (vCall != null) {
				vCall.getCurrentParamsCopy().setVideoEnabled(true);
				
				Log.d("vCall.cameraEnabled() = " + vCall.cameraEnabled());
				Log.d("vCall.getCurrentParamsCopy().getVideoEnabled() = " + vCall.getCurrentParamsCopy().getVideoEnabled());
